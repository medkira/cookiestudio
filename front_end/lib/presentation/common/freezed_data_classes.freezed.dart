...
abstract class $LoginObjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userEmail, String password});
}
...
class _$_LoginObject implements _LoginObject {
  _$_LoginObject(this.userEmail, this.password);
  ...
  @override
  String toString() {
    return 'LoginObject(userEmail: $userEmail, password: $password)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userEmail, password);
...
abstract class _LoginObject implements LoginObject {
  factory _LoginObject(final String userEmail, final String password) =
      _$_LoginObject;
