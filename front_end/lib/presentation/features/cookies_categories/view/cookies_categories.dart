...
Widget _tabBarView() {
  return Builder(
    builder: (context) {
      return SizedBox(
        height: MediaQuery.of(context).size.height - AppSize.s214,
        child: TabBarView(
  ...
  return LayoutBuilder(
    builder: (BuildContext context, BoxConstraints constraints) {
      return GridView.builder(
        ...
        itemCount:
            20, // ! You can adjust this count as needed => the count gonna be the lenght of array of data taht been fetch from the api
